...
def main():
    ...
    while True:  # Loop infinito para mostrar o menu repetidamente
        ...
        codigo = input("Escreva o código que deseja: ")
        ...
        if codigo == "1":
            ...
            email = input("Escreva o email do usuário: ")
            senha = input("Escreva a senha do usuário: ")
            ...
            email = input("Escreva o e-mail do usuário que deseja buscar: ")
            ...
            if usuario:
                ...
                escolha = input("EScreva o código da alteração que deseja fazer: ")
                ...
                if escolha == "1":
                    ...
                    novo_email = input("Escreva o novo e-mail: ")
                    usuario.email = novo_email
                    print(f"\nE-mail atualizado com sucesso para: {usuario.email}")

                elif escolha == "3":
                    nova_senha = input("Escreva a nova senha: ")
            ...
            nome = input("Escreva o nome do usuário que deseja excluir: ")
            senha = input("Escreva a senha do usuário: ")
